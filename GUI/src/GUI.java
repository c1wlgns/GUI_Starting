		...
		public MyGUI() {
			...
			jbtn1.addActionListener(new ActionListener() {
				...
				public void actionPerformed(ActionEvent e) {
					...
					String kor = jtf2.getText();
					String math = jtf3.getText();
					String eng = jtf4.getText();

					Integer total = Integer.parseInt(kor) + Integer.parseInt(eng) + Integer.parseInt(math);
					Integer average = (Integer.parseInt(kor) + Integer.parseInt(eng) + Integer.parseInt(math)) / 3;
			...
			jbtn3.addActionListener(new ActionListener(){
				...
				public void actionPerformed(ActionEvent e) {
					...
					int average = Integer.parseInt(kor) + Integer.parseInt(math) + Integer.parseInt(eng)/3;
